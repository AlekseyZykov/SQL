/* 
PostgreSQL 16
Данный запрос предназначен для расчета Rolling Retention 1, 3, 7, 14, 30, 60, и 90 дня в разрезе месячных когорт пользователей онлайн-школы за 2022 год. 
...
--Для каждой когорты рассчитываем Rolling Retention 1, 3, 7, 14, 30, 60, и 90 дня
select
    cohort,
