/* 
PostgreSQL 16
Данный запрос предназначен для расчета N-DAY-retention 1, 3, 7, 14, 30, 60, и 90 дня в разрезе месячных когорт пользователей онлайн-школы. 
 ...
 */
--Объединяем пользователей в когорты по месяцу регистрации
with a as (
    select
        u.user_id,
